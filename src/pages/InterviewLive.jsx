...
- Always speak in English`
  ...
  const endInterview = async () => {
    ...
    try { analysis = await analyzeInterview(apiKey, tText, targetRole, cvText) }
      ...
      analysis = {
        overallScore: 7, summary: 'Interview completed successfully.', strengths: [], improvements: [],
        questionAnalysis: [], communicationScore: 7, technicalScore: 7, confidenceScore: 7,
        tip: 'Keep practicing with IntervueX!',
      }
    }
  ...
  const stateLabel = {
    idle: 'Initializing...', connecting: 'Connecting...', connected: 'Connected',
    listening: 'Listening', speaking: 'AI Speaking', disconnected: 'Disconnected',
  }
          ...
          {showChat && (
            ...
            >
              <div className="flex items-center justify-between px-4 py-3 border-b border-white/5">
                ...
                <button onClick={() => setShowChat(false)} className="p-1 rounded hover:bg-white/5">
                  ...
                  >
                    ...
                    <div className={`max-w-[85%] px-3 py-2 rounded-xl text-sm leading-relaxed ${
                      msg.role === 'user'
                        ...
                        : 'bg-secondary/10 border border-secondary/20 rounded-bl-sm'
                    }`}>
                      {msg.text}
                    </div>
                  </motion.div>
